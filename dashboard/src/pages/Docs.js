...
const Docs = () => {
    return (
        <div className="container text-start">
                <h1>React Templates Installation</h1>
            <div className="row align-items-center">
                <div className="col-lg-12 col-md-6">
                    ...
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text.
                        ...
                        essor at Hampden-Sydney College in Virginia, looked up one of the
                ...
                <div className="col-lg-12 col-md-6">
                    ...
                    <p>  There are many variations of passages of Lorem Ipsum available,
                         ...
                         ted humour, or randomised words which don't look even slightly 
                         believable. If you are going to use a passage of Lorem Ipsum, y
                         ou need to be sure there isn't anything embarrassing hidden in 
                         the middle of text. All the Lorem Ipsum generators on the Inter
                         net tend to repeat predefined chunks as necessary, making this 
                         the first true generator on the Internet. It uses a dictionary 
                         of over 200 Latin words, combined with a handful of model sent
                         ence structures, to generate Lorem Ipsum which looks reasonabl
                         e. The generated Lorem Ipsum is therefore always free from rep
